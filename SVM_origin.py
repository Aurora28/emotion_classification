...
def getData():
	...
	# train_e, test_e, train_ye, test_ye = train_test_split(e, y, test_size = 0.1)
...
def test(model, test_x, test_y):
	...
	with open('data/SVM.json','w',encoding='utf-8') as file:
		file.write(jsonstr)
...
if __name__=='__main__':
	...
	joblib.dump(model, 'model/SVM.m')
	
	# test_x, test_y = stc_data()
	# use_model('model/SVM.m', test_x, test_y)
